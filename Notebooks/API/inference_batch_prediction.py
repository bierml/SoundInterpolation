...
if __name__ == '__main__':
    ...
    if(len(sys.argv)<6):
        ...
        if(T>0.0001):
          ...
          nn_restored = tf.signal.stft(nn_restored,256,128,256)  #дискретное оконное преобразование Фурье, размер преобразования - 256, шаг - 128, окно Хэмминга (наложение 50% + окно Ханна - NOLA, обеспечивается инвертируемость)
