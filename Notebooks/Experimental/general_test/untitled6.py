...
Original file is located at
    https://colab.research.google.com/drive/1Nw8j9eZJZxgI65v6STdiisg5zd4ehDMG
"""
...
'''for i in range(len(samples_sequences_clipped)):
  print(len(samples_sequences_clipped[i]))'''
for i in range(len(samples_sequences)):
  print(len(samples_sequences[i]))
#print(len(samples_sequences_clipped[0]))
#print(len(samples_sequences))